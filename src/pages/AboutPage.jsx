        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="text-gray-700 leading-relaxed">
              Hệ thống <strong>HIV Treatment and Medical Services System</strong>{" "}
              được phát triển nhằm tăng cường tiếp cận dịch vụ y tế và điều trị HIV
              cho bệnh nhân tại cơ sở y tế. Chúng tôi cam kết hỗ trợ người bệnh một
              cách toàn diện, minh bạch và bảo mật.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-700 leading-relaxed">
              Nhóm phát triển gồm các chuyên gia công nghệ và bác sĩ có nhiều năm kinh
              nghiệm trong điều trị HIV/AIDS và phát triển phần mềm y tế.
            </p>
          </div>
