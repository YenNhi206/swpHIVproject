...
export default function CreatePrescription() {
    ...
    const handleSubmit = async (e) => {
        ...
        const payload = {
            ...
            notes: form.notes,
            status: "ACTIVE", // Bắt buộc để tránh lỗi 400
        };
    ...
    return (
        <div className="max-w-3xl mx-auto mt-8 p-6 bg-white rounded-2xl shadow-md border">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                {/* Chọn phác đồ */}
                <div>
                    <label className="block font-medium text-gray-700 mb-1">Phác đồ ARV</label>
                    <select
                        name="protocolId"
                ...
                {/* Ngày kết thúc */}
                <div>
                    <label className="block font-medium text-gray-700 mb-1">Ngày kết thúc</label>
                    <div className="flex items-center border rounded-lg px-3 py-2">
                        <Calendar className="w-5 h-5 text-gray-500 mr-2" />
                        <input
                            type="date"
                ...
                {/* Hướng dẫn sử dụng */}
                <div>
                    <label className="block font-medium text-gray-700 mb-1">Hướng dẫn sử dụng</label>
                    <textarea
                ...
                <div>
                    <label className="block font-medium text-gray-700 mb-1">Điều chỉnh liều lượng</label>
                    <textarea
