          ...
          <div className="flex justify-center items-center py-3 space-x-6">
            ...
            {user?.role === 'ADMIN' && (
              <motion.div whileHover={{ scale: 1.05 }} transition={{ duration: 0.2 }}>
                <Link
                  to="/admin"
                  className={`flex items-center gap-2 py-2 px-4 rounded-t-lg transition-colors duration-300 ${isActive('/admin')
            ...
            {user?.role === 'DOCTOR' && (
              <motion.div whileHover={{ scale: 1.05 }} transition={{ duration: 0.2 }}>
                <Link
                  to="/doctor"
                  className={`flex items-center gap-2 py-2 px-4 rounded-t-lg transition-colors duration-300 ${isActive('/doctor')
                    ? 'text-red-700 border-b-4 border-red-700 bg-red-100 font-bold'
                    : 'text-gray-700 hover:text-red-600 hover:bg-red-50 hover:border-b-2 hover:border-red-200'
                    }`}
                >
            ...
            {user?.role === 'STAFF' && (
              <motion.div whileHover={{ scale: 1.05 }} transition={{ duration: 0.2 }}>
                <Link
                  to="/staff"
                  className={`flex items-center gap-2 py-2 px-4 rounded-t-lg transition-colors duration-300 ${isActive('/staff')
                    ? 'text-red-700 border-b-4 border-red-700 bg-red-100 font-bold'
                    : 'text-gray-700 hover:text-red-600 hover:bg-red-50 hover:border-b-2 hover:border-red-200'
                    }`}
                >
